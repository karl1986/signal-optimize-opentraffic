...
#Run the main function Step 2
start_time = timeSys.time()
num_cores = multiprocessing.cpu_count()
if __name__ == '__main__':
    Parallel(n_jobs=num_cores)(delayed(mainFunction_step2_createTrips)(namelist,pathname,timeDiffThres,*(list(intersectionDF.loc[i,])[1:])) for i in intersectionDF.index.values)
